...
// Styled Components (Reused from Login but adapted if needed)
    ...
    return (
        <PageWrapper>
            ...
            <RightSection>
                <BrandContent>
                    <BrandLogo>✨</BrandLogo>
                    <BrandTitle>Join MindMate</BrandTitle>
                    <BrandSubtitle>
                        Your personal mental wellness companion is ready to meet you.
                    </BrandSubtitle>
                </BrandContent>
            </RightSection>
        </PageWrapper>
